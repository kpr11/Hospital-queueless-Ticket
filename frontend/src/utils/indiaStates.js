 ...
 *
 * Used by the admin Settings page: pick a state, then pick a district. The two
 * are stored together as a single "District, State" string in `config.location`
 * (shown in the footer status bar and on printed tokens).
 *
 * District lists follow official state notifications as of 2023-24. Districts are
 * occasionally re-organised; the "Other…" option on the form covers any gap.
 */
...
/** Ordered list of state / UT names for the first dropdown. */
